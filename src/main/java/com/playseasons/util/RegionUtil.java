...
public class RegionUtil {
    ...
    public static boolean spawnContains(Location location) throws NullPointerException {
        ProtectedRegion spawn = WorldGuardPlugin.inst().getRegionManager(Bukkit.getWorlds().get(0)).getRegion(Setting.SPAWN_REGION);
    ...
    public static boolean visitingContains(Location location) throws NullPointerException {
        ProtectedRegion visiting = WorldGuardPlugin.inst().getRegionManager(Bukkit.getWorlds().get(0)).getRegion(Setting.VISITOR_REGION);
