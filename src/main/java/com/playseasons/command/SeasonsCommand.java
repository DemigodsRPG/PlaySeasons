...
public class SeasonsCommand extends BaseCommand {
    ...
    protected CommandResult onCommand(CommandSender sender, Command command, String[] args) {
        sender.sendMessage(
                ChatColor.YELLOW + "Welcome to" + ChatColor.DARK_GREEN + " Seasons" + ChatColor.YELLOW + "!");
        sender.sendMessage(
                ChatColor.DARK_GREEN + "Seasons" + ChatColor.YELLOW + " is a Coop-Survival Minecraft server.");
